# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-10-29 02:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_clinic_visit_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2002, 1, 1)), django.core.validators.MaxValueValidator(datetime.date(2016, 6, 1))])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_date', models.DateField(blank=True, null=True, validators=[edc_base.model.validators.date.date_not_future, django.core.validators.MinValueValidator(datetime.date(2002, 1, 1))], verbose_name='Date entered into care')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, help_text='DO NOT include any information that could be used to identify the patient.', max_length=150, null=True)),
                ('report_datetime', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('attended', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('unknown', 'Unknown')], default='unknown', max_length=15, verbose_name='Did the patient attend this clinic visit?')),
                ...
                ('disclosure_by_caregiver', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('unknown', 'Unknown')], default='unknown', help_text="If <= 18 years, is there evidence that the caregiver has disclosed the patient's HIV status to others?", max_length=15, verbose_name='Evidence of disclosure of HIV status by caregiver?')),
            ],
            options={
                'abstract': False,
            },
