# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-13 07:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oi', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=25, verbose_name='Non-TB Opportunistic Infections since last visit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ba_namotswe.Enrollment')),
            ],
        ),
        migrations.CreateModel(
            name='Treatment',
