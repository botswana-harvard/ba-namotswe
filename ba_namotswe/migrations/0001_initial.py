    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dob', models.DateField(validators=[edc_base.model.validators.date.date_not_future], verbose_name='Date of Birth')),
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female')], max_length=25, verbose_name='Gender')),
                ('initial_visit_datetime', models.DateField(help_text='Day/Month/Year', validators=[edc_base.model.validators.date.date_not_future], verbose_name='Date of Initial Clinic Visit')),
                ('caregiver_relation', models.DateField(help_text='Please describe the caregiver/next of kin\'s relationship to patient if "Other"', verbose_name='Caregiver/Next of Kin Relationship')),
                ('caregiver_relation_other', models.CharField(max_length=25, verbose_name='Caregiver/Next of Kin Relationship: "Other"')),
                ('weight', models.IntegerField(help_text='Please check the box if weight was unavailable at initial visit', verbose_name='Weight at Initial Clinic Visit')),
                ('height', models.IntegerField(help_text='Please check the box if height was unavailable at initial visit', verbose_name='Height at Initial Clinic Visit')),
                ('hiv_diagnosis_date', models.DateField(default='', validators=[edc_base.model.validators.date.date_not_future], verbose_name='HIV Diagnosis Date ')),
        ...
        migrations.AddField(
            model_name='abstraction',
            name='io_history',
            field=models.ManyToManyField(to='ba_namotswe.Io', verbose_name='Opportunistic Infections Since last visit'),
        ),
        migrations.AddField(
            model_name='abstraction',
            name='subject_visit',
