# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-10-28 05:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regimen', models.CharField(choices=[('EFV/TDF/FTC', 'NNRTI: EFV + TDF/FTC'), ('EFV + ABC/3TC', 'NNRTI: EFV + ABC/3TC'), ('RPV/TDF/FTC', 'NNRTI: RPV + TDF/FTC)'), ('(DRV/r) + TDF/FTC', 'PI: Darunavir/ritonavir (DRV/r) + TDF/FTC'), ('ATV/r + ABC/3TC', 'PI: ATV/r + ABC/3TC'), ('DRV/r + ABC/3TC', 'PI: DRV/r + ABC/3TC'), ('LPV/r + ABC/3TC', 'PI: Lopinavir/ritonavir LPV/r + ABC/3TC'), ('LPV/r + ABC/3TC', 'PI: Lopinavir/ritonavir LPV/r + TDF/FTC'), ('(RAL) + TDF/FTC', 'INSTI: Raltegravir (RAL) + TDF/FTC'), ('RAL + ABC/3TC', 'INSTI: Raltegravir (RAL) + ABC/3TC'), ('EVG/COBI/TDF/FTC', 'INSTI: EVG/COBI/TDF/FTC'), ('(DTG) + ABC/3TC', 'INSTI: Dolutegravir (DTG) + ABC/3TC'), ('DTG + TDF/FTC', 'INSTI: Dolutegravir (DTG) + + TDF/FTC')], max_length=25)),
                ('started', models.DateField(blank=True, null=True)),
                ('stopped', models.DateField(blank=True, null=True, verbose_name='Stopped/Held')),
                ('status', models.CharField(choices=[('ongoing', 'Ongoing'), ('HELD', 'Held'), ('STOPPED', 'Stopped')], default='ongoing', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_date', models.DateField(validators=[edc_base.model.validators.date.date_not_future], verbose_name='Date entered into care')),
                ...
                ('entry_weight', models.DecimalField(blank=True, decimal_places=2, help_text='Provide if available.', max_digits=5, null=True, validators=[django.core.validators.MinValueValidator(20), django.core.validators.MaxValueValidator(136)], verbose_name='Weight at entry (kg)')),
                ...
                ('entry_height', models.DecimalField(blank=True, decimal_places=2, help_text='Provide if available.', max_digits=5, null=True, validators=[django.core.validators.MinValueValidator(100), django.core.validators.MaxValueValidator(244)], verbose_name='Height at entry (cm)')),
                ('hiv_dx_date', models.DateField(help_text='Provide if available.', null=True, validators=[edc_base.model.validators.date.date_not_future], verbose_name='HIV Diagnosis Date ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ongoing', 'Ongoing'), ('resolved', 'Resolved')], default='resolved', max_length=15)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tb_type', models.CharField(choices=[('PULMONARY TB', 'Pulmonary TB'), ('NON PULMONARY TB', 'Non pulmonary TB')], max_length=30, verbose_name='TB type')),
                ('dx_method', models.CharField(choices=[('CULTURE POSITIVE', 'Culture Positive'), ('CXR', 'CXR'), ('OTHER IMAGING MODALITY', 'Other Imaging Modality'), ('CLINICAL DIAGNOSIS', 'Clinical Diagnosis'), ('OTHER', 'Other, describe')], max_length=30, verbose_name='Diagnosis method')),
